...
const InteractiveCat: React.FC = () => {
  ...
  const catResponses = {
    happy: [
      "喵喵喵！很高兴见到你！🐱",
      "今天天气真不错，想和我一起玩耍吗？",
              "我是Verdis的唯一宠物VerdisDoge，请多关照！",
      "你的笑容让我心情很好呢！",
      "喵！今天BTC又涨了，心情超好！",
      "AI技术真是太神奇了，让我变得更聪明了！",
                      "Verdis平台上的meme总是让我笑个不停！",
        "喵喵，让我们一起探索Web3的世界吧！"
    ],
    curious: [
      "咦？你在做什么呢？",
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (input.includes('btc') || input.includes('比特币') || input.includes('bitcoin')) {
        ...
        mood = 'curious'
      } else if (input.includes('verdis') || input.includes('短视频')) {
        const verdisResponses = [
          "喵！Verdis平台上的内容太有趣了！📱",
          "喵喵，Verdis的6秒短视频创意无限！🎬",
          "喵？你在看Verdis？我也喜欢那些搞笑的视频！😂",
          "喵！Verdis的社区氛围很棒！❤️",
          "喵！6秒的创意，永恒的经典！🌟"
        ]
        response = verdisResponses[Math.floor(Math.random() * verdisResponses.length)]
        mood = 'excited'
